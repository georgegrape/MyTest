...
@interface RelationshipController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation RelationshipController
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    return [RelationshipCell hyb_heightForTableView:tableView config:^(UITableViewCell *sourceCell) {
        RelationshipCell *cell = (RelationshipCell *)sourceCell;
        // 配置数据
        cell.model = model;
    } cache:^NSDictionary *{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    RelationshipCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        cell = [[RelationshipCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
